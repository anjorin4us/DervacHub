...
<template>
    <div class="py-[40px] bg-white px-[3.7rem] max-[464px]:px-[1rem]">
        ...
        <div class="flex items-center flex-col justify-center mt-12">
            ...
            <p class="text-[20px] text-[#475467] text-center max-w-[980px]">Candidates are expected to be intentional about learning, be physically present at all classes, Mondays to Thursdays, from 9am – 2pm; take your lessons seriously and participate in all your assessments, assignments and projects which will enable them bridge their skill-gaps and stand a better chance accelerate your pace to secure a future in the tech space.</p>
        </div>
    </div>
