...
<template>
    <section id="sixth-section" class="overflow-hidden h-[100vh] md:px-24 px-8 pt-12 w-full grid grid-cols-2 gap-10 bg-[whitesmoke] max-[1285px]:grid-cols-2 max-[1285px]:items-center max-[1285px]:h-fit">
